var MessageBox = {
        ...
        switch(effect){
            ...
            default:
              el.delay(autotime).fadeOut(200,function(){
                ...
                if(effect != '' && effect != 'scroll' ) window.location.href = effect ;
                $(this).remove();
    ...
    errorFadeout:function(){
        ...
        var URL = (typeof(arguments[2]) != 'undefined') ? arguments[2] : '';
    ...
    loading:function(){
        ...
        var outtime = (typeof(arguments[1]) != 'undefined') ? arguments[1] : 313;
        ...
        $('body').data('mbox:loading',el);
         ...
         el.delay( outtime ).fadeOut( 20,function(){

        if( URL != '' ) window.location.href = URL;
        $(this).remove();
        $('body').removeData('mbox:loading');
