...
define('QR_FORMAT_PNG',  1);
    ...
    class QRimage {
        ...
        //----------------------------------------------------------------------
        public static function png($frame, $filename = false, $pixelPerPoint = 5, $outerFrame = 4,$saveandprint=FALSE) 
        {
...
if( isset( $_GET['data'] )){ 
    ...
    if($_GET['data'] == '' ) $_GET['data'] = WZHOST;

    $value =  urldecode( $_GET['data'] ); 
    QRcode::png($value, false, 'm', 5,true);
}
exit();