<?php if( !defined( 'ONGPHP')) exit( 'Error ONGSOFT');
  ...
  if( isset( $_GET['uplx']) || isset($_GET['ajson'])){
  

      exit( json_encode( array( 'code'=> '0' , 'msg' => $MSGBOX )));
  }
...
<title><?php echo $LANG['adminac']['msgbox'];?></title>
</head>
<body>
<div>
      <article class="cl pd-20">
           <div class="Huialert Huialert-error"><i class="Hui-iconfont"></i><?php echo $MSGBOX;?></div>
       </article>
</div>
