    ...
    <nav class="navbar navbar-default navbar-fixed-top m-component-nav" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header text-center clearfix">
          ...
          <span class="navbar-title">找回密码</span>
        </div>
      </div>
    </nav>
    ...
    <section class="m-component-login" id="m-login">
       <div class="container">
          <form id="registerForm">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <span class="input-group-btn">
                    <button class="btn btn-default" type="button" id="TestGetCode" onclick="return facode(2);"><span>点击获取</span><span class="hide">还剩<b id="timeout">60</b>秒</span></button>
                  </span>
                </div>
            </div>
            ...
            <div class="">
                <button type="button" class="btn btn-success btn-block" id="m-submit" onclick="return zpass();" >找回密码</button>
            </div>
          </form>   
        </div>
    </section>
