        ...
        <form class="mui-input-group" style="background:transparent;margin-top:2px;" action="post">
            ...
            <div class="mui-input-row ">
                ...
                <div class="inputfdong">
                    ...
                    <button type="button" class="mui-btn mui-btn-danger" style="width:100px;" id="TestGetCode" onclick="return facode(1);"> 
                        <span class="mui-badge mui-badge-primary"> 点击获取 </span> 
                    </button>
            ...
            auto 10px auto; " onclick="return reg();">注 册</button>
