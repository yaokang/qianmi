...
<body>
        ...
        <div class="mui-content mui-col-xs-3" id="jstyperl" style="float:left;overflow-y: auto;background-color: #f5f5f5;">


        <ul class="main-nav " style="border:none;">

            <?php $TYPE = menulist( $LANG['cpid'] , $D );
            ...
            <li class="dalei<?php echo $ONG['id'] == $DATA['id'] || $ONG['id'] == $DATA['cid']  ?' active':'';?>"  data="<?php echo $ONG['id']?>"> <span class="btt"> <?php echo $ONG['name'];?> </span>


                <?php $ZTYPE = menulist( $ONG['id'] , $D );
                
                
                if( $ZTYPE ){ 
                  ?><ul class="sub-nav" > 

                        <li <?php echo  $ONG['id'] == $DATA['id']  ?'class="active"':'';?> data="<?php echo $ONG['id']?>"> <span> 全部 </span> </li>
                        <?php foreach( $ZTYPE as $ZONG ){ ?>
                        <li data="<?php echo $ZONG['id']?>" <?php echo  $ZONG['id'] == $DATA['id']  ?'class="active"':'';?>> <span> <?php echo $ZONG['name'];?> </span> </li>
                        <?php } ?>
                    </ul>
                <?php } ?>
